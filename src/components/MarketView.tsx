...
export function MarketView({ onSelectGift }: MarketViewProps) {
  ...
  const marketListings: (Gift & {
    ...
    },
    {
      ...
      name: 'Cash Cannon',
      serialNumber: 1,
      image: 'https://i.suar.me/WPBxr/l',
      modelUrl: 'https://i.suar.me/WPBxr/l',
      modelName: 'Diamond Cannon',
      modelRarity: '5%',
      background: 'https://i.suar.me/V9BKK/l',
      backgroundName: 'Gold',
      backgroundRarity: '2%',
    ...
    },
    {
      ...
      name: 'Cash Cannon',
      serialNumber: 88,
      image: 'https://i.suar.me/PpMOQ/l',
      modelUrl: 'https://i.suar.me/PpMOQ/l',
      modelName: 'Cyber Blaster',
      modelRarity: '15%',
      background: 'https://i.suar.me/Lpozo/l',
      backgroundName: 'Black',
      backgroundRarity: '5%',
